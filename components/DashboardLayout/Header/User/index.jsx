      ...
      {(icon || image) && (
        ...
        >
          {icon ? (
            ...
            <Image src={image} alt="" className="size-[12px] aspect-square" />
          )}
        </div>
      )}
      <div className="flex flex-col gap-[8px] items-start justify-center flex-1">
        <p className="font-inter font-medium text-[12px] tracking-[-0.56px] leading-[10px] text-[#19363f]">
          {title}
        </p>
        {description && (
    ...
    <Menu className="relative outline-none" as="div">
      ...
      >
        <div className="flex p-[0_20px] pb-[8px] justify-center items-center gap-[10px]">
          <label className="text-[#19363F] leading-normal font-inter text-[16px] font-medium tracking-[-0.64px]">
            Menu
          </label>
        </div>
