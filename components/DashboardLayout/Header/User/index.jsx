...
const UserDashboard = ({ isSpecialPage }) => {
  ...
  return (
    <Menu className="relative outline-none" as="div">
      ...
      <MenuItems
        className={cn(
          "z-1000 [--anchor-gap:1.5rem] [--anchor-offset:-0.1rem] origin-top transition duration-200 ease-out outline-none shadow-popover data-[closed]:scale-95 data-[closed]:opacity-0",
