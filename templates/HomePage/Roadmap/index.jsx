            ...
            rightItems={[
              {
                ...
                extra: (
                  ...
                  >
                    {/* Hot Button */}
                    <div className="bg-green-500 h-[20px] border border-[rgba(255,255,255,0.2)] border-solid flex items-center absolute rounded-[100px] -rotate-12 left-[-20px] top-[20px]">
            ...
            rightItems={[
              ...
              },
              {
                ...
                extra: (
                  ...
                  >
                    {/* Hot Button */}
                    <div className="bg-[#3471FD] h-[20px] border border-[rgba(255,255,255,0.2)] border-solid flex items-center absolute rounded-[100px] -rotate-12 left-[-20px] top-[20px]">
                      <div className="flex gap-[3px] h-full  items-center justify-center overflow-hidden px-[4px] relative rounded-[inherit]">
                        <p className="font-medium text-[10px] text-white tracking-tight whitespace-nowrap">
                          Habilitado
                        </p>
