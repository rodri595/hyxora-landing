...
const Access = () => {
  return (
    <section id="camino" className="Access--container">
      <div className="Access-ellipse-background" />

      <div className="Access-outer-content">
        <div className="Access--content">
          <div className="Access--content-b">
            Accede a tu sitio en <strong>Hyxora</strong>
          </div>
          <div className="Access-div">
            <div className="Access-div-a" />
            <div className="Access-div-b" />
        ...
        <div className="Access-list">
          <div className="Access-list-item">
            <div className="Access-list-item-box">
              <span>01</span>
            </div>
